...
require 'Controladores//Campo_Cons//Cont_Campo.php';
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-8" id="prueba">
                <div class="container-fluid">
                    <?php
                    include_once 'Vista/Cancha_Cons/form.php';
                    include_once 'Vista/Cancha_Cons/profile.php';
                    ?>
                    ...
                    <?php
                    include_once 'Vista/Cancha_Cons/playerstable.php';
                    ?>
                    <nav id="pagination">
                    </nav>
