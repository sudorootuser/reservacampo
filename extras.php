...
<?php
// <!-- Headers -->
include_once './Vista/HeadersExtras.php';
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-8" id="prueba">
                <div class="container-fluid">
                    <?php
                    include_once 'Vista/Extras/form.php';
                    include_once 'Vista/Extras/profile.php';
                    ?>
                    ...
                    <div class="alert alert alert-success " role="alert" style="margin-top:10px;background-color: #caf406;background-image: url('Recursos/Imagenes/FondoLoguin.png')">
                        <h4 class="text-light text-center">EQUIPO ADICIONAL</h4>
                    </div>
                    <div class="row mb-3">
                        <div class="col-3">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#userModal" id="addnewbtn">AÑADIR EQUIPO</button>
                        </div>
                        <div class="col-9">
                    ...
                    <?php
                    include_once 'Vista/Extras/playerstable.php';
                    ?>
                    <nav id="pagination">
                    </nav>
