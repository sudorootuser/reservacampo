    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Crear / Actualizar</h5>
            ...
            <form id="addform" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Nombre de la Cancha:</label>
                    ...
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Tipo de Cancha</label>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                            ...
                            <select name="tipo" id="tipo" class="form-control" aria-label="Default select example">
                                <option value="Sinteticos">Sintetico</option>
                                <option value="Polvo Ladrillo">Polvo Ladrillo</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Mantenimiento</label>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-bars" aria-hidden="true"></i></span>
                            </div>
                            <select name="email" id="email" class="form-control" aria-label="Default select example">
