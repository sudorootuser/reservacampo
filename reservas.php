...
<?php
// <!-- Headers -->
include_once './Vista/HeadersReserva.php';
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-8" id="prueba">
                <div class="container-fluid">
                    <?php
                    include_once 'Vista/Reserva/form.php';
                    ?>
                    ...
                    <div class="alert alert alert-success " role="alert" style="margin-top:10px;background-color: #caf406;background-image: url('Recursos/Imagenes/FondoLoguin.png')">
                        <h4 class="text-light text-center">LISTADO DE RESERVAS</h4>
                    </div>
                    <div class="row mb-3">
                        <div class="col-3">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#userModal" id="addnewbtn">NUEVA RESERVA</button>
                        </div>
                        <div class="col-9">
                    ...
                    <?php
                    include_once 'Vista/Reserva/playerstable.php';
                    ?>
                    <nav id="pagination">
                    </nav>
